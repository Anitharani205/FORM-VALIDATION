    ...
    event.preventDefault();
     ...
     const phone = document.getElementById("phone").value.trim();
         if (!/^[A-Za-z\s]+$/.test(fullName)) { alert("Please enter a valid full name."); return false;
    }
    ...
    return true;
      ...
      const confirmPassword = document.getElementById("confirmpassword").value.trim(); const dob = document.getElementById("dob").value;
    ...
    const birthDate = new Date(dob); if (birthDate >= new Date()) {
    alert("Date of Birth cannot be in the future."); return false;
    }
    ...
    function validateReviewAndSubmitForm() { return true;
    }
